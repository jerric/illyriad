...
public abstract class AuthenticatedHttpClient<I, O> extends HttpClient<I, O> {
  ...
  public static class GetHtml
      extends AuthenticatedHttpClient<Map<String, String>, Optional<Document>> {
  ...
  public static class PostJson<T>
      extends AuthenticatedHttpClient<Map<String, String>, Optional<T>> {
    public PostJson(
        String url,
        Class<T> type,
        Map<Type, JsonDeserializer<?>> deserializers,
